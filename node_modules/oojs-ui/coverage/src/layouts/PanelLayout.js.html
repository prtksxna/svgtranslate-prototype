...
&nbsp;
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( config.framed ) {
<span class="cstat-no" title="statement not covered" >		this.$element.addClass( 'oo-ui-panelLayout-framed' );</span>
	}
};
&nbsp;
/* Setup */
