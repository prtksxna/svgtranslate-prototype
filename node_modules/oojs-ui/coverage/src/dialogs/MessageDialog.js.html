...
<span class="cstat-no" title="statement not covered" >		this.$actions.append( others[ i ].$element );</span>
<span class="cstat-no" title="statement not covered" >		others[ i ].toggleFramed( true );</span>
	}
...
&nbsp;
	...
	for ( i = 0, len = actions.length; i &lt; len; i++ ) {
		action = actions[ i ];
		<span class="missing-if-branch" title="if path not taken" >I</span>if ( action.$element[ 0 ].scrollWidth &gt; action.$element[ 0 ].clientWidth ) {
