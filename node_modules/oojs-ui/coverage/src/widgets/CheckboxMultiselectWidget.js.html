 ...
 */
OO.ui.CheckboxMultiselectWidget = <span class="fstat-no" title="function not covered" >function OoUiCheckboxMultiselectWidget( config ) {</span>
	// Parent constructor
<span class="cstat-no" title="statement not covered" >	OO.ui.CheckboxMultiselectWidget.parent.call( this, config );</span>
&nbsp;
	// Properties
<span class="cstat-no" title="statement not covered" >	this.$lastClicked = null;</span>
&nbsp;
	// Events
<span class="cstat-no" title="statement not covered" >	this.$group.on( 'click', this.onClick.bind( this ) );</span>
&nbsp;
	// Initialization
