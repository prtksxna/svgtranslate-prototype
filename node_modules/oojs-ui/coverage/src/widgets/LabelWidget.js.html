...
&nbsp;
	// Initialization
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( this.input ) {
<span class="cstat-no" title="statement not covered" >		if ( this.input.getInputId() ) {</span>
<span class="cstat-no" title="statement not covered" >			this.$element.attr( 'for', this.input.getInputId() );</span>
		} else {
