...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5289×</span>
<span class="cline-any cline-yes">5289×</span>
...
OO.ui.InputWidget.static.gatherPreInfuseState = function ( node, config ) {
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if ( config.$input &amp;&amp; config.$input.length ) {
...
OO.ui.InputWidget.prototype.restorePreInfuseState = function ( state ) {
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if ( state.value !== undefined &amp;&amp; state.value !== this.getValue() ) {
<span class="cstat-no" title="statement not covered" >		this.setValue( state.value );</span>
	}
