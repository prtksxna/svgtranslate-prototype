...
$( '#login' ).on( 'click', function () {
  ...
  OO.ui.confirm( 'You will be redirected to Commons in order to confirm your identity. SVG Translate will use this to upload your translations.' ).done( function (c) {
    if (c) {
